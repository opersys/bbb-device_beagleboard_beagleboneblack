...
BOARD_KERNEL_CMDLINE := console=ttyS0,115200n8 androidboot.console=ttyS0 rootwait ro g_ffs.idVendor=0x18d1 g_ffs.idProduct=0xd002 g_ffs.iSerialNumber=0x12345678 androidboot.hardware=am335xevm qemu=1 qemu.gles=0
